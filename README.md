About spatialdata-plot-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/spatialdata-plot-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/spatialdata-plot-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add spatialdata-plot
# for installing globally
pixi global install spatialdata-plot
```
...
It is possible to list all of the versions of `spatialdata-plot` available on your platform:
...
```
pixi search spatialdata-plot --channel conda-forge
```
